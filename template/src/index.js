...
function fallbackRender({ error, resetErrorBoundary }) {
    ...
    return (
      <div role="alert">
        <div style={{ width: '100%', minHeight: '100vh', boxSizing: 'border-box', color: "yellow", padding: "20px", fontWeight: 400, fontSize: '1.5rem', display: 'flex', flexDirection: 'column', backgroundColor: 'rgba(0, 0, 0, 0.9)'}}>
          <p>{error.message}</p>
